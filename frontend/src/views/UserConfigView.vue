<template>
  <div class="page-container">
    ...
    <div class="container">
      ...
      <form id="user-settings-form" action="/update-user" method="POST">
        <div class="mb-3">
          <label for="username" class="form-label"
            >Cambiar Nombre de Usuario</label
          >
          <input
            type="text"
            class="form-control"
        ...
        <div class="mb-3">
          <label for="balance" class="form-label">Añadir Saldo</label>
          <input
            type="number"
            class="form-control"
            id="balance"
      ...
      <button class="btn btn-secondary button" @click="LogoutUser">
        Cerrar Sesión
      </button>
...
.button:hover {
  opacity: 0.8; /* Cambiar la opacidad al pasar el cursor sobre el botón */
}
